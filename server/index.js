...
function joinGame(socket) {
  ...
  //whenever new player comes, we set unmatched to be the old player's socket.id
  //so new player's opponent will be set as old player and his symbol will get changed as then unmatced will exist
  //then we set it to null until a 3rd player enters, and its checked when 4th player enters
  if (unmatched) {
